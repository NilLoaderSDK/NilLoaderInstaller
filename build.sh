...
jar --create --file dist/NilLoaderInstaller-0.1.1.jar --main-class me.tamkungz.nilloaderinstaller.Main -C build-manual/classes .
echo "Built dist/NilLoaderInstaller-0.1.1.jar"
